...
cv::Mat Implement::getPatch(const cv::Mat& im, cv::Rect& rect) {
...
std::vector<cv::Rect> Implement::parseCandidatePatches(const cv::Mat& im) {
std::cout<<"salient detecting"<<endl;
